        ...
        <Image source={icons.logo} className="w-12 h-10 mt-20 mb-5 mx-auto"></Image>
        {
          moviesLoading || trendingLoading? (
            ...
            <View className="flex-1 mt-5">
              <SearchBar onPress={() => router.push("/search")} placeholder="Search for a movie" value={""} onChangeText={function (text: string): void {
                  ...
                  trendingMovies && (
                    <View className="mt-10">
                      ...
                      <FlatList 
                        ...
                        keyExtractor={(item) => item.movie_id.toString()}></FlatList>
                    </View>
                  )
                }
              <>
